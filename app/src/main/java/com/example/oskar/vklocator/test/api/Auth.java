package com.example.oskar.vklocator.test.api;

import android.util.Log;

import com.example.oskar.vklocator.test.utils.Utils;
...
public class Auth {
    ...
    public static String getUrl(String api_id, String settings){
        String url="https://oauth.vk.com/authorize?client_id="+api_id+"&display=mobile&scope="+settings+"&redirect_uri="+URLEncoder.encode(redirect_url1)+"&response_type=token"
