...
import com.example.oskar.vklocator.test.api.Auth;
...
public class LoginWebActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://oauth.vk.com/authorize?client_id=" + MainActivity.API_ID + "&scope=wall,offline,friends,messages=&response_type=token";
